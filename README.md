...
![Блок-схема последовательной обработки инструкций (SEQ)](./readme_assets/seq.png "Рис. 1. Блок-схема последовательной обработки инструкций (SEQ)")
...
![Блок-схема конвейерной обработки инструкций (PIPE)](./readme_assets/pipe.png "Рис. 2. Блок-схема конвейерной обработки инструкций (PIPE)")
...
![Визуализация конвейерной обработки инструкций](./readme_assets/pipeline.png "Рис. 3. Визуализация конвейерной обработки инструкций")
...
Но схема на рисунке 3 будет работать корректно только если во всех
...
-   **NOP (No Operation):** самое лёгкое решение. На этапе генерации
    ...
    зависимых по данным (Рис. 4).

    ![Останова, реализованная через NOP для решения проблемы риска по данным](./readme_assets/nop.png "Рис. 4. Останова, реализованная через NOP для решения проблемы риска по данным")

-   **"Пузырёк" (bubble, Привет дед!):** Аппаратная приостановка
    конкретных этапов обработки инструкций, зависящих по данным.

    ![Останова, реализованная через "пузырёк" для решения проблемы риска по данным](./readme_assets/babble.png "Рис. 5. Останова, реализованная через 'пузырёк' для решения проблемы риска по данным")

-   **Продвижение (forwarding):** Мы добавляем в нашу конструкцию
    процессора возможность передачи значений (регистров,
    ...
    окончания обработки ожидаемой инструкции.

    ![Визуализация продвижения назад при зависимости по данным](./readme_assets/forwarding.png "Рис. 6. Визуализация продвижения назад при зависимости по данным")
...
архитектура процессора называется суперскалярной (superscalar) и хорошо дополняет конвейерное устройство функциональных блоков.

![Блок-схема суперскалярного процессора](./readme_assets/supscalar.png "Рис. 7. Блок-схема суперскалярного процессора")
...
-   ноутбук (опционально)
    ...
    ![Характеристики ноутбука, на котором выполняется работа](./readme_assets/nout.png "Рис. 8. Характеристики ноутбука, на котором выполняется работа")
...
![Визуализация множества Мандельброта без оптимизаций](./readme_assets/mand_O0.png "Рис. 9. Визуализация множества Мандельброта без оптимизаций")
...
![Визуализация множества Мандельброта c наивными оптимизациями](./readme_assets/mand_O3.png "Рис. 10. Визуализация множества Мандельброта c наивными оптимизациями")
...
![Визуализация множества Мандельброта на интринсиках](./readme_assets/mand_avx2.png "Рис. 11. Визуализация множества Мандельброта на интринсиках")
...
![Визуализация множества Мандельброта на интринсиках c развёртыванием](./readme_assets/mand_avx2_unroll.png "Рис. 12. Визуализация множества Мандельброта на интринсиках c развёртыванием")
...
![Визуализация множества Мандельброта на массивах c развёртыванием](./readme_assets/mand_arr.png "Рис. 13. Визуализация множества Мандельброта на массивах c развёртыванием")
...
![График зависимости времени выполнения от итерации](./readme_assets/stat_check.png "Рис. 14. График зависимости времени выполнения от итерации")
...
![Гистограмма увеличения производительности наивными оптимизациями](./readme_assets/histogram0.png "Рис. 15. Гистограмма увеличения производительности наивными оптимизациями")
...
![Гистограмма увеличения производительности не наивными оптимизациями](./readme_assets/histogram1.png "Рис. 16. Гистограмма увеличения производительности не наивными оптимизациями")
